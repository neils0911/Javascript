...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
       ...
       if(activePlayer === 'O') {
            //This functon disables clicking for computer choice.
            disableClick();
...
//drawWinLine function is call to draw line if condition is met.    
function checkWinConditions() {
     ...
     // o 3, 4, 5 condition
     else if (arrayIncludes('3o', '40', '5o')) { drawWinLine(50, 304, 558, 304); }
     // o 6, 7, 8 condition
...
//This function makes our body element temprarily unclickable.
...
function animateLineDrawing() {
     ...
     c.moveTo(x1, y1);
     //This method indicates the end ppint in our line.
     c.lineTo(x, y);
     //This method sets the width of our line.
     c.lineWidth = 10;
     //This method sets the colour of the line.
